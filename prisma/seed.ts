  ...
  const products = [
    {
      ...
      brandName: 'DECIEM Beauty Group Inc.',
      usages: ['Giá phải chăng', 'Hiệu quả sáng da rõ rệt', 'Kết cấu nhẹ, thấm nhanh'],
      usageInstructions: ['Sử dụng sau bước làm sạch và toner', 'Có thể gây châm chích trên da nhạy cảm'],
    ...
    },
    {
      ...
      brandName: 'Beauty of Joseon Co., Ltd.',
      usages: ['SPF50+ PA++++', 'Không nhờn rít', 'Phù hợp da nhạy cảm'],
      usageInstructions: ['Thoa đều lên da trước khi ra nắng 20 phút', 'Cần apply lại sau 2-3 tiếng'],
    ...
    },
    {
      ...
      brandName: 'Rohto Pharmaceutical Co., Ltd.',
      usages: ['Làm sạch sâu', 'Không gây khô da', 'Không mùi'],
      usageInstructions: ['Massage trên da khô, nhũ hóa với nước ấm'],
    ...
    },
    {
      ...
      brandName: 'Torriden Inc.',
      usages: ['Công thức nhẹ nhàng giúp da căng bóng'],
      usageInstructions: ['Lấy 2-3 giọt vỗ nhẹ lên da'],
