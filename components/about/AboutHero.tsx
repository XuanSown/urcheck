...
export function AboutHero() {
  ...
  return (
    <section className="relative min-h-[92vh] flex flex-col items-center justify-center pt-28 sm:pt-32 pb-16 px-4 sm:px-6 lg:px-8 overflow-hidden bg-gradient-to-b from-gray-50 via-white to-white dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 grain-overlay">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <Link href="/customer/register" className="w-full sm:w-auto">
            <Button
              variant="secondary"
              size="lg"
